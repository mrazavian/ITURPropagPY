...
class _ITU835_6():
    ...
    def standard_water_vapour_pressure(self, h, h_0=2.0, rho_0=7.5):    # Eq. 7
        """
        Section 1.2 of ITU-R P.835-6
        """
        rho_h = standard_water_vapour_density(h, h_0, rho_0).value
        T_h = standard_temperature(h).value
        e_h = rho_h * T_h / 216.7                                       # Eq. 8
        return e_h
