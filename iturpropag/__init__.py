...
from iturpropag.models.iturp676.gaseous_attenuation_inclined_path import gaseous_attenuation_inclined_path
from iturpropag.models.iturp676.gaseous_attenuation_terrestrial_path import gaseous_attenuation_terrestrial_path
...
from iturpropag.__version__ import __version__

AUTHORS = "Inigo del Portillo"
#EDITOR = "Mojtaba Razavian"



def atmospheric_attenuation_slant_path(
        lat, lon, f, el, p, D, tau, eta, hs=None, rho=None, R001=None, T=None,
        H=None, P=None, hL=1e3, V_t=None, mode='approx',
    ...
    if include_gas:
        Ag = gaseous_attenuation_slant_path(f, el, rho, P, T, V_t=V_t, h=hs, mode=mode)
    else:
        Ag = 0 * u.dB
